...
// example no.3
function clickLike(){
    document.getElementById('ex3_img').src="images/like.png";
}
function clickLove(){
...
function colorChange(){
    document.getElementById('tc_change').style.color="red";
}
// example no.5
function showText(){
...
// function rAdditionTwo(){
//     document.getElementById('r_aTwo').innerHTML=result;
// }
// // example no.11
// var number5 = 9;
// var number6 = 3;
...
// function rAdditionThree(){
//     document.getElementById('r_aThree').innerHTML=result;
// }
...
// example no.18
function overMouse(){
    window.alert('Hi, This is Mobarok');
}
// example no.19
function leaveMouse(){
...
let answer2 = "He is called 'Roni'";
let answer3 = 'He is called "Bijoy"'; 
...
let text222 = `Hi, iam ${firstName}, ${lastName}.`;
